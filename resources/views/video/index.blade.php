  ...
  <div class="container">
    ...
    <div class="row">
      ...
      @if( Auth::guard('webguru')->check() )
        <div class="d-flex">
          <a href="/guru/video/create" class="btn text-white ms-auto mb-3" style="background-color: orange;">Tambah Video</a> 
          <a href="/guru/video/shared" class="btn text-white mb-3 ms-1" style="background-color: orange;">Manajemen Video</a>
        </div>
      @endif
      ...
      <div class="row">
        <div class="col-xxl-4 col-md-4">
            <form action="/guru/video" method="get">
          ...
          <div class="card rounded">
            <div class="card-body mt-3">
              ...
              @if ($item->kode_guru != '' || $item->kode_guru != null)
                <p class="m-0">Dibuat oleh : {{ $item->guru->nama }}</p>
              @else
                <p class="m-0">Dibuat oleh : Administrator</p>
              @endif
