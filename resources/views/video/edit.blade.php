...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/guru/video/shared">Manajemen Video</a></li>
        <li class="breadcrumb-item active"><a href="/guru/video/{{ $video->id }}/edit">Edit</a></li>
      </ol>
  </nav>
</div>
  ...
  <div class="col-lg-8">
    <div class="card">
      <div class="card-body table-responsive">
        ...
        {{-- form --}}
        <form action="/guru/video/{{ $video->id }}" method="post" class="mt-3">
          @method('patch')
          @csrf
          ...
          <div class="d-flex">
            <a href="/guru/video/shared" class="btn mt-2 ms-auto" style="color:orange;border: 1px solid orange;">Kembali</a> 
