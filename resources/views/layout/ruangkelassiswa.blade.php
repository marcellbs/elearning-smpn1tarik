...
<body>
  ...
  <aside id="sidebar" class="sidebar">
      ...
      <div class="row">
        ...
        <div class="col-8 p-0">
          <h6 class="mb-0 mt-3 fw-bold text-sm-start">{{ auth()->user()->nama_siswa }}</h6>
          <h6 class="mt-0 text-sm-start">Siswa</h6>
        </div>
      </div>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('siswa/detail/' . $hash->encode($pengampu->id) )) ? 'active' : '' }}" href="/siswa/detail/{{ $hash->encode($pengampu->id )}}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('siswa/video-kelas/' .  $hash->encode($pengampu->id) )) ? 'active' : '' }}" href="/siswa/video-kelas/{{ $hash->encode($pengampu->id )}}">
          <i class="bi bi-play-btn"></i><span>Video</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link {{ (Request::is('siswa/materi-kelas/' .  $hash->encode($pengampu->id) )) ? 'active' : '' }}" href="/siswa/materi-kelas/{{ $hash->encode($pengampu->id )}}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('siswa/tugas-kelas/' . $hash->encode($pengampu->id ))) ? 'active' : '' }}" href="/siswa/tugas-kelas/{{ $hash->encode($pengampu->id )}}">
