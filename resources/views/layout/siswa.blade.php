  ...
  <aside id="sidebar" class="sidebar">
    <div class="text-center">
      @if (file_exists(public_path('img/siswa/' . auth()->user()->foto)))
        <img src="/img/siswa/{{ auth()->user()->foto }}" alt="user-img" class="rounded-circle image-profile img-thumbnail p-0">
      @else
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/siswa/logout" class="{{ (Request::is('siswa/logout')) ? 'active' : '' }}" >
